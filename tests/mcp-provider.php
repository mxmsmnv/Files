...
$checks = [
	...
	'library statistics use portable conditional aggregates' => substr_count($module, 'SUM(CASE WHEN kind=') === 2 && !str_contains($module, 'SUM(kind='),
	'release versions are synchronized' => str_contains($module, 'public const VERSION = 103') && str_contains($module, "'version' => 103") && str_contains((string)file_get_contents($root . '/ProcessFiles.module.php'), "'version' => 103"),
