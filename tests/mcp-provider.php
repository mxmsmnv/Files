...
$checks = [
	...
	'release versions are synchronized' => str_contains($module, 'public const VERSION = 102') && str_contains($module, "'version' => 102") && str_contains((string)file_get_contents($root . '/ProcessFiles.module.php'), "'version' => 102"),
