...
$checks = [
	...
	'settings inspect the configured database driver' => str_contains($service, "'sqlite'=>'pdo_sqlite'") && str_contains($service, "'pgsql'=>'pdo_pgsql'") && !str_contains($service, "'postgresql'=>'pdo_pgsql'") && str_contains($service, "default=>'pdo_mysql'"),
